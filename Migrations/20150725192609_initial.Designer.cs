...
namespace FancyApp.Migrations
{
    ...
    partial class initial
    {
        ...
        {
            get { return "20150725192609_initial"; }
        }
        ...
        public override void BuildTargetModel(ModelBuilder builder)
        {
            ...
            builder.Entity("FancyApp.Model.ApplicationUser", b =>
                {
            ...
            builder.Entity("FancyApp.Model.ValueModel", b =>
                {
                    b.Property<int>("Id")
                        .GenerateValueOnAdd()
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("FancyApp.Model.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
